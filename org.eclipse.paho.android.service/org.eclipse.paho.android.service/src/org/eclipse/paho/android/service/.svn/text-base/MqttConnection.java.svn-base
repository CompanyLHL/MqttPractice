...
//				conOpt.setCleanSession(cleanSession);//设置清除会话信息 TRUE 清除  fasle 不清除 可以接收到先前发送的信息
//				conOpt.setConnectionTimeout(10000);//设置超时时间
//				conOpt.setKeepAliveInterval(20000);
//				 connectOptions = conOpt;
